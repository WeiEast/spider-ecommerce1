...
public class ChongQing10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            String templateData = "Account={}&UType=201&ProvinceID=04&AreaCode=&CityNo=&RandomFlag=0&Password={}&Captcha=";
            String data = TemplateUtils.format(templateData, param.getMobile(), URLEncoder.encode(encryptPassword, "UTF-8"));
            response = TaskHttpClient.create(param, RequestType.POST, "chong_qing_10000_web_001").setFullUrl(templateUrl).setReferer(referer)
            ...
            referer = "http://cq.189.cn/account/index.htm";
            templateUrl = "http://www.189.cn/dqmh/my189/checkMy189Session.do?fastcode=02031273";

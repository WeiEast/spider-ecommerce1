...
public class ShanDong10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("shan_dong_10000_web/des.js");
            ...
            response = TaskHttpClient.create(param, RequestType.POST, "shan_dong_10000_web_001").setFullUrl(templateUrl).setReferer(referer)

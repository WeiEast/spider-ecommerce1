...
public class ZheJiang10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            String templateData = "Account={}&UType=201&ProvinceID=16&AreaCode=&CityNo=&RandomFlag=0&Password={}&Captcha=";
            String data = TemplateUtils.format(templateData, param.getMobile(), URLEncoder.encode(encryptPassword, "UTF-8"));
            response = TaskHttpClient.create(param, RequestType.POST, "zhe_jiang_10000_web_001").setFullUrl(templateUrl).setReferer(referer)
            ...
            templateUrl = "http://www.189.cn/login/sso/ecs.do?method=linkTo&platNo=10012&toStUrl=http://zj.189.cn/zjpr/balancep/getBalancep.htm";
    ...
    private HttpResult<Map<String, Object>> refeshSmsCodeForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param, RequestType.GET, "zhe_jiang_10000_web_005").setFullUrl(templateUrl)

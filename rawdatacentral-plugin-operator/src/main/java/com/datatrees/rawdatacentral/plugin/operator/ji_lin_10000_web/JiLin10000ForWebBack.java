 ...
 * Date: 2017/10/10
 */
public class JiLin10000ForWebBack implements OperatorPluginService {

    private static Logger                     logger     = LoggerFactory.getLogger(JiLin10000ForWebBack.class);
    ...
    private HttpResult<String> refeshPicCodeForUserInfo(OperatorParam param) {
        ...
        try {
            ...
            String referer = "http://www.189.cn/dqmh/my189/initMy189home.do?fastcode=00710602";
    ...
    private HttpResult<Map<String, Object>> validatePicCodeForUserInfo(OperatorParam param) {
        ...
        try {
            ...
            String pageContent = response.getPageContent();
            logger.info("测试-->" + response.getPageContent());

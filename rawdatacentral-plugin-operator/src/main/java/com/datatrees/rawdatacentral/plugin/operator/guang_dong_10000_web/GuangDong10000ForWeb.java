...
public class GuangDong10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<String> refeshPicCodeForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(), param.getWebsiteName(), RequestType.GET, "guang_dong_10000_web_008")
    ...
    private HttpResult<Map<String, Object>> validatePicCodeForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param, RequestType.POST, "guang_dong_10000_web_009").setFullUrl(templateUrl).setRequestBody(data)
                    .setReferer(referer).invoke();

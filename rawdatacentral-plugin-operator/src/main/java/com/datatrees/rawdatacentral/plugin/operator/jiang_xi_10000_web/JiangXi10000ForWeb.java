...
public class JiangXi10000ForWeb implements OperatorPluginService {
    ...
    private static final String javaScript2     = "";
    ...
    private HttpResult<Map<String, Object>> refeshSmsCodeForLogin(OperatorParam param) {
        ...
        try {
            ...
            String referer = "http://jx.189.cn/public/v4/logon/loginPop.jsp?from_sc=service_login&ret_url=";
            response = TaskHttpClient.create(param, RequestType.POST, "jiang_xi_10000_web_004").setFullUrl(templateUrl).setReferer(referer).setRequestBody(templateData).invoke();
            pageContent = response.getPageContent();
            String cookieRandom = ProcessorContextUtil.getCookieString(PluginFactory.getProcessorContext());
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            String referer = "http://jx.189.cn/public/v4/logon/loginPop.jsp?from_sc=service_login&ret_url=";
            response = TaskHttpClient.create(param, RequestType.POST, "jiang_xi_10000_web_005").setFullUrl(templateUrl).setReferer(referer).setRequestBody(templateData).invoke();
            String pageContent = response.getPageContent();
            ...
            response = TaskHttpClient.create(param, RequestType.POST, "jiang_xi_10000_web_006").setFullUrl(templateUrl).setReferer(referer).setRequestBody(templateData).invoke();
            pageContent = response.getPageContent();
            ...
            String encryptSmsCode = invocable.invokeFunction("encryptedString", modulus, param.getSmsCode()).toString();
            String encryptMobile = invocable.invokeFunction("encryptedString", modulus, param.getMobile()).toString();
            templateUrl = "http://jx.189.cn/dwr/call/plaincall/Service.excute.dwr";
            ...
            referer = "http://jx.189.cn/public/v4/logon/loginPop.jsp?from_sc=service_login&ret_url=";
            response = TaskHttpClient.create(param, RequestType.POST, "jiang_xi_10000_web_007").setFullUrl(templateUrl).setReferer(referer).setRequestBody(templateData).invoke();
            pageContent = response.getPageContent();

...
public class OssService {
	 ...
	 * @throws FileNotFoundException
	 */
	public String putObject(String bucketName, String key, String filePath)
			throws FileNotFoundException {
	 ...
	 * @param metadata
	 *            {@link ObjectMetadata}
	 *            用户对该object的描述，由一系列name-value对组成；其中ContentLength是必须设置的
	 * @return
	 */
	public String putObject(String bucketName, String key,
			InputStream inputStream, ObjectMetadata metadata) {
		// 上传Object.
		PutObjectResult result = ossClient.putObject(bucketName, key,
	 ...
	 * @throws IOException
	 */
	public String putObject(String bucketName, String key, Object object)
			throws IOException {
	 ...
	 * @return
	 */
	public List<OSSObjectSummary> listObjectSummaries(String bucketName,

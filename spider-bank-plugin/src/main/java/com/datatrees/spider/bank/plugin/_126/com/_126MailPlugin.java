...
package com.datatrees.spider.bank.plugin._126.com;
 ...
 * Date: 2018/2/26
 */
public class _126MailPlugin implements CommonPlugin, QRPlugin {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (isLoginSuccess(driver, param)) {
                            ...
                            BeanFactoryUtils.getBean(CommonPluginService.class).sendLoginSuccessMsg(TopicEnum.SPIDER_BANK.getCode(),loginMessage, SeleniumUtils.getCookies(driver));
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (StringUtils.equals(qrStatus, QRStatus.SUCCESS) && TaskUtils.isLastLoginProcessId(taskId, processId)) {
                            ...
                            BeanFactoryUtils.getBean(CommonPluginService.class)
                                    .sendLoginSuccessMsg(TopicEnum.SPIDER_BANK.getCode(), loginMessage, SeleniumUtils.getCookies(driver));

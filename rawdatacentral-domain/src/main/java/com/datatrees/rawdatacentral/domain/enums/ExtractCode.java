...
public enum ExtractCode {
    ...
    EXTRACT_SUCCESS(0, "Extract success"), EXTRACT_CONF_FAIL(2, "No conf or conf parse fail"), ERROR_INPUT(4, "Extract error input"), EXTRACT_FAIL(6,
            "Extract fail code"), EXTRACT_STORE_FAIL(8, "Extract store failed");

...
@Component
@Order(1)
public class EcommerceMqStartedListener implements ApplicationListener<ContextRefreshedEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(EcommerceMqStartedListener.class);
    ...
    private void startSpiderMqConsumer(ApplicationContext applicationContext) throws MQClientException {
        ...
        DefaultMQPushConsumer consumer = applicationContext.getBean("ecommerceSpiderConsumer", DefaultMQPushConsumer.class);
        consumer.subscribe(TopicEnum.SPIDER_ECOMMERCE.getCode(), "*");

...
@Service
public class ExtraSpiderStartMessageHandler implements MessageHandler {

    private static final Logger          logger = LoggerFactory.getLogger(ExtraSpiderStartMessageHandler.class);
    ...
    public String getTopic() {
        return TopicEnum.SPIDER_EXTRA.getCode();
    }

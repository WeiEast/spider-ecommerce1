package com.datatrees.spider.extra.service.mq;
...
@Component
@Order(1)
public class ExtraMqStartedListener implements ApplicationListener<ContextRefreshedEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExtraMqStartedListener.class);
    ...
    private void startSpiderMqConsumer(ApplicationContext applicationContext) throws MQClientException {
        ...
        DefaultMQPushConsumer consumer = applicationContext.getBean("extraSpiderConsumer", DefaultMQPushConsumer.class);
        consumer.subscribe(TopicEnum.SPIDER_EXTRA.getCode(), "*");

...
public class ChongQing10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param, RequestType.POST, "chong_qing_10000_web_002").setFullUrl(templateUrl).setReferer(referer)
                    .invoke();
            ...
            response = TaskHttpClient.create(param, RequestType.GET, "chong_qing_10000_web_003").setFullUrl(templateUrl).setReferer(referer).invoke();

            templateUrl = "http://cq.189.cn/new-bill/bill_XDCX?accNbr={}&productId=208511296&billingModeId=2100";
            response = TaskHttpClient.create(param, RequestType.POST, "chong_qing_10000_web_004").setFullUrl(templateUrl, param.getMobile()).invoke();
    ...
    private HttpResult<Map<String, Object>> refeshSmsCodeForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param, RequestType.POST, "chong_qing_10000_web_005").setFullUrl(templateUrl).setReferer(referer)
                    .invoke();
            String pageContent = response.getPageContent();

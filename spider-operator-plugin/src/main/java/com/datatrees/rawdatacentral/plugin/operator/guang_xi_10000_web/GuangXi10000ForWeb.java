...
public class GuangXi10000ForWeb implements OperatorPluginService {
    ...
    private HttpResult<Map<String, Object>> submitForLogin(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_001").setFullUrl(templateUrl).setReferer(referer)
            ...
            if (StringUtils.contains(pageContent, "<rs_up_num></rs_up_num>")) {
                ...
                response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_002").setFullUrl(templateUrl).setReferer(referer)
                        .setRequestBody(data).invoke();
                ...
                response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_003").setFullUrl(templateUrl).setReferer(referer)
                        .setRequestBody(data).invoke();

                referer = templateUrl;
                templateUrl = "http://gx.189.cn/service/account/";
                data = "CUSTBRAND=&ESFlag=8&REDIRECT_URL=%2F2015%2F";
                response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_004").setFullUrl(templateUrl).setReferer(referer)
                        .setRequestBody(data).invoke();
    ...
    private HttpResult<Map<String, Object>> refeshSmsCodeForUserInfo(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_005").setFullUrl(templateUrl).setRequestBody(data)
    ...
    private HttpResult<Map<String, Object>> submitForUserInfo(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_006").setFullUrl(templateUrl).setRequestBody(data)
                    .setReferer(referer).invoke();
            String pageContent = response.getPageContent();
    ...
    private HttpResult<Map<String, Object>> refeshSmsCodeForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            String data = TemplateUtils.format(templateData, param.getMobile());
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_007").setFullUrl(templateUrl).setRequestBody(data)
                    .setReferer(referer).invoke();
            String pageContent = response.getPageContent();
            ...
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_008").setFullUrl(templateUrl).setRequestBody(data)
                    .setReferer(referer).invoke();
    ...
    private HttpResult<Map<String, Object>> submitForBillDetail(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_009").setFullUrl(templateUrl).setRequestBody(data)
                    .setReferer(referer).invoke();
            String pageContent = response.getPageContent();
            if (StringUtils.contains(pageContent, "<Tips>")) {
                ...
                response = TaskHttpClient.create(param.getTaskId(),param.getWebsiteName(), RequestType.POST, "guang_xi_10000_web_010").setFullUrl(templateUrl).setRequestBody(data)
                        .setReferer(referer).invoke();
                pageContent = response.getPageContent();

package com.datatrees.spider.share.service.plugin.operator.ji_lin_10000_web;
...
public class JiLin10000ForWeb implements OperatorPlugin {
    ...
    private HttpResult<Map<String, Object>> validatePicCodeForUserInfo(OperatorParam param) {
        ...
        try {
            ...
            response = TaskHttpClient.create(param.getTaskId(), param.getWebsiteName(), RequestType.POST).setUrl(templateUrl).setParams(params)

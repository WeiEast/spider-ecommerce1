package com.datatrees.spider.share.service.plugin.operator.an_hui_10000_web;
 ...
 * Date: 2017/9/25
 */
public class AnHui10000ForWeb implements OperatorPlugin {
    ...
    private HttpResult<Object> processForPdf(OperatorParam param) {
        ...
        Response response = null;
        try {
            response = TaskHttpClient.create(param.getTaskId(), param.getWebsiteName(), RequestType.POST).setFullUrl(params[0])
                    .setRequestBody(params[1]).invoke();

...
public enum ResultClassType {
    MAIL_BILL("Mail.Bill"), OPERATOR_PERSONALINFORMATION("Operator.PersonalInformation"), OPERATOR_BILLDETAIL("Operator.BillDetail"), OPERATOR_SHORTMESSAGEDETAIL(
            "Operator.ShortMessageDetail"), OPERATOR_CALLDETAIL("Operator.CallDetail"), ECOMMERCE_BASEINFO("Ecommerce.BaseInfo"), ECOMMERCE_RECORDS(
            "Ecommerce.Records"), ECOMMERCE_ADDRESSES("Ecommerce.Addresses"), ECOMMERCE_BANKCARDS("Ecommerce.BankCards"), ECOMMERCE_FEESACCOUNTS(
            "Ecommerce.FeesAccounts");

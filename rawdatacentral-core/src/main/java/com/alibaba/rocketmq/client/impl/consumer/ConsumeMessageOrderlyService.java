...
public class ConsumeMessageOrderlyService implements ConsumeMessageService {
    ...
    public ConsumeMessageOrderlyService(DefaultMQPushConsumerImpl defaultMQPushConsumerImpl, MessageListenerOrderly messageListener) {
        ...
        String consumeExecutorName = StringUtils.isEmpty(defaultMQPushConsumerImpl.getConsumeName()) ? "ConsumeMessageThread-" : defaultMQPushConsumerImpl.getConsumeName() + "-";
        ...
        String scheduledThreadName = StringUtils.isEmpty(defaultMQPushConsumerImpl.getConsumeName()) ? "ConsumeMessageScheduledThread_" : defaultMQPushConsumerImpl.getConsumeName() + "ScheduledThread_";

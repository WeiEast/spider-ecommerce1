...
public class ConsumeMessageOrderlyService implements ConsumeMessageService {
    ...
    public ConsumeMessageOrderlyService(DefaultMQPushConsumerImpl defaultMQPushConsumerImpl, MessageListenerOrderly messageListener) {
        ...
        String scheduledThreadName =
                StringUtils.isEmpty(defaultMQPushConsumerImpl.getConsumeName()) ? "ConsumeMessageScheduledThread_" : defaultMQPushConsumerImpl
                        .getConsumeName() + "ScheduledThread_";
                ...
                if (MessageModel.BROADCASTING.equals(ConsumeMessageOrderlyService.this.defaultMQPushConsumerImpl.messageModel())
                    ...
                    for (boolean continueConsume = true; continueConsume;) {
                        ...
                        if (!msgs.isEmpty()) {
                            ...
                            // 记录统计信息
                            ConsumeMessageOrderlyService.this.getConsumerStatsManager().incConsumeRT(ConsumeMessageOrderlyService.this.consumerGroup,

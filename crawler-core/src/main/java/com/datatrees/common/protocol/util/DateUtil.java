...
public class DateUtil {
    ...
    private static final Date OLD_TWO_DIGIT_YEAR_START;
    ...
    static {
        ...
        OLD_TWO_DIGIT_YEAR_START = calendar.getTime();
    }
     ...
     */
    public static Date parseDate(String dateValue, boolean expirFlag) throws DateParseException {
        return parseDate(dateValue, null, null, expirFlag);
    }
     ...
     */
    public static Date parseDate(String dateValue, Collection dateFormats, boolean expirFlag) 
        throws DateParseException {
        return parseDate(dateValue, dateFormats, null, expirFlag);
    }

    public static Date parseDate(String dateValue, Collection dateFormats) throws DateParseException {
        return parseDate(dateValue, dateFormats, null, false);
    }
    ...
    public static Date parseDate(
        ...
        Date startDate, boolean expireFlag 
    ) throws DateParseException {
        ...
        if (startDate == null) {
            if(expireFlag)
                startDate = OLD_TWO_DIGIT_YEAR_START;
            else

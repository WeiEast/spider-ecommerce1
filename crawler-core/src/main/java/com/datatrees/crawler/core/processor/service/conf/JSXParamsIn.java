...
public class JSXParamsIn {
	...
	public JSXParamsIn setNetexportPageLoadedTimeout(
			int netexportPageLoadedTimeout) {
	...
	public boolean equals(Object obj) {
		...
		if (netexportEnable != other.netexportEnable)
			return false;
		if (netexportPageLoadedTimeout != other.netexportPageLoadedTimeout)
			return false;
		if (pageLoadTimeout != other.pageLoadTimeout)
			return false;
		if (pageScriptTimeout != other.pageScriptTimeout)
			return false;
		if (toLoadImage != other.toLoadImage)
			return false;
	...
	public String toString() {
		return "ParamsIn [cookie=" + cookie + ", http_proxy=" + httpProxy
				+ ", last_modified_time=" + lastModifiedTime + ", page_id="
				+ page_id + ", waiting_time=" + waitingTime + ", page_url="
				+ pageUrl + ", referer=" + referer + ", video_url_pattern="
				+ videoUrlPattern + ", video_return_type=" + videoReturnType
				+ ", to_save_image=" + toSaveImage + ", to_trigger_onclick="
				+ toTriggerOnclick + ", anchor_on=" + anchorOn + ", in_iframe="
				+ inIframe + ", to_load_image=" + toLoadImage
				+ ", to_return_page=" + toReturnPage + ", page_load_timeout="
				+ pageLoadTimeout + ", page_script_timeout="
				+ pageScriptTimeout + ", netexport_pageLoaded_timeout="
				+ netexportPageLoadedTimeout + ", click_element="
				+ clickElement + ", to_return_stream=" + toReturnStream
				+ ", netexport_enable=" + netexportEnable + ", browser_type="
				+ browserType + "]";
	}
}

...
public class CodecOperationImpl extends Operation {
	...
	public void process(Request request, Response response) throws Exception {
		...
		if (log.isDebugEnabled()) {
			log.debug("CodecOperation input: "
					+ String.format("regex: %s, index: %s", cdType, handlType));
		}
	 ...
	 * @return
	 */
	private String handlerCodec(String orginal, CodecType cdType,
			HandlingType handlType, String charset) {
		String result = orginal;
	 ...
	 */
	private String handlerURL(HandlingType handlType, String orginal,
	 ...
	 * @return
	 */
	private String handlerBase64(HandlingType handlType, String orginal,
	 ...
	 * @return
	 */
	private String handlerMd5(HandlingType handlType, String orginal,
			String charset) throws Exception {
		String result = orginal;
		byte[] sourceBytes = orginal.getBytes(charset);
		switch (handlType) {

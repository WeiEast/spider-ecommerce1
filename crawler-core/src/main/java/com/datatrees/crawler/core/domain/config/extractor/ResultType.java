...
public enum ResultType {
    String("string"), NUMBER("number"), DATE("date"), PAYMENT("payment"), RESOURCESTRING("resource_string"), FILE("file"), CURRENCY(
            "currency"), CURRENCYPAYMENT("currency_payment"), RMB("rmb"), BOOLEAN("boolean"), INT("int"), LONG("long");

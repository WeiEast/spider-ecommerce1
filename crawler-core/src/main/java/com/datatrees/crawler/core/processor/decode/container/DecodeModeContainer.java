...
public class DecodeModeContainer {
        ...
        if (StringUtils.isNotEmpty(unicodeFormat)) {
            try {
                Map<UnicodeMode, String> decoders =
                        (Map<UnicodeMode, String>) GsonUtils.fromJson(unicodeFormat,
                                new TypeToken<Map<UnicodeMode, String>>() {}.getType());
    ...
    static class Cache {
        ...
        private static Map<Configuration, DecodeModeContainer> cache =
                new HashMap<Configuration, DecodeModeContainer>();

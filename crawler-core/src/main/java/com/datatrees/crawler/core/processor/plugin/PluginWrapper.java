...
public class PluginWrapper {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.JSON_STYLE).append("file", file.getAbsolutePath())
            .append("plugin", plugin.getFileName()).append("forceReload", forceReload).toString();
    }
}

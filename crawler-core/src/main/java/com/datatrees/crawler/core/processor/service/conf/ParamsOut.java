...
public class ParamsOut {
	...
	public void adddSearchFormInfo(String searchPostDataTemplate,
			String searchURLTemplate, String urlCharset) {
		searchFormInfo.add(new Search(searchPostDataTemplate,
				searchURLTemplate, urlCharset));
	}

	public void adddExtracted_links(String anchor_text, String url,
			String iframe_type) {
	...
	public static	class Search {
		...
		Search(String searchPostDataTemplate, String searchURLTemplate,
				String urlCharset) {

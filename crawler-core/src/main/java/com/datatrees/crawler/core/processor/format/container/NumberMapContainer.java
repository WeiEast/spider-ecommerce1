...
public class NumberMapContainer {
    ...
    private void initMap(String config, Map<String, NumberUnit> customNumberMapper) {
        if (StringUtils.isNotEmpty(config)) {
            try {
                @SuppressWarnings("unchecked") Map<String, String> perids = (Map<String, String>) GsonUtils.fromJson(config, new TypeToken<Map<String, String>>() {}.getType());
    ...
    static class Cache {
        ...
        private static Map<Configuration, NumberMapContainer> cache = new HashMap<Configuration, NumberMapContainer>();

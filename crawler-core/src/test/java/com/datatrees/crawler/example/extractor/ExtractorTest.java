...
public abstract class ExtractorTest extends BaseTest {
    ...
    private static final String[] BILL_FIELDS           = {"NameOnCard", "BillMonth", "BillStartDate", "CardNums", "BillDate", "PaymentDueDate", "CreditLimit", "FCCreditLimit", "NewBalance", "FCNewBalance", "MinPayment", "FCMinPayment", "LastBalance", "FCLastBalance", "LastPayment", "FCLastPayment", "NewCharges", "FCNewCharges", "Adjustment", "FCAdjustment", "Interest", "FCInterest", "Integral", "IntegralAdd", "IntegralUsed", "ShoppingSheet", "Installment"};
    private static final String[] SHOPPING_SHEET_FIELDS = {"CardNo", "TransDate", "PostDate", "Description", "CurrencyType", "AmountMoney"};
    private static final String[] INSTALLMENT_FIELDS    = {"InstallmentInfo", "ImTotalTerm", "RecordedTerm", "ImTotalBalance", "UnRecordedBalance", "ImNewBalance", "InstallmentDate", "ImNewFees"};
    protected final      Logger   logger                = LoggerFactory.getLogger(getClass());
    private ExtractorProcessorContext context;

    @Before
    public void setUp() throws Exception {
        ExtractorProcessorContext context = createExtractorProcessorContext(getWebsite(), getConfigFile());
    ...
    protected abstract void addSimpleExtractParameters(Map<String, Object> map) throws Exception;

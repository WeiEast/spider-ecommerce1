...
public class URLCookieFetcherTest {
    ...
    public void testCookieParser() {
        String cookie =
                "BAIDUID=CD71C59BDC34995D86794255769930CA:FG=1; expires=Thu, 31-Dec-37 23:55:55 GMT; max-age=2147483647; path=/; domain=.baidu.com;";// "BDSVRTM=0; path=/;H_PS_PSSID=5778_5229_1450_5224_5288_5723_4264_4759; path=/; domain=.baidu.com";

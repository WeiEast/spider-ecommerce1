...
public abstract class BaseExtractorTest extends BaseConfigTest {
    ...
    private final String[] SHOPPING_SHEET_FIELDS = {"CardNo", "TransDate", "PostDate", "Description", "CurrencyType", "AmountMoney"};
    private final String[] INSTALLMENT_FIELDS    = {"InstallmentInfo", "ImTotalTerm", "RecordedTerm", "ImTotalBalance", "UnRecordedBalance", "ImNewBalance", "InstallmentDate", "ImNewFees"};
    ...
    protected abstract void addSimpleExtractSource(Map<String, Object> map) throws Exception;

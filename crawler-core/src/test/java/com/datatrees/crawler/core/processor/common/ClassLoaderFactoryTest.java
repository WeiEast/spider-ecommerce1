...
public class ClassLoaderFactoryTest {
    ...
    public void testGetClassLoader() {
        ...
        unpaked.add(f);
        try {
            ClassLoader loader = ClassLoaderFactory.createClassLoader(unpaked.toArray(new File[unpaked.size()]),
                paked.toArray(new File[paked.size()]), this.getClass().getClassLoader());

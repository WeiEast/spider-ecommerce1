...
//            context.setProxyManager(new SimpleProxyManager());
          ...
          //  context.getContext().put("sid", PatternUtils.group(url, "sid=([^&]*)", 1));
            ...
            CrawlRequest request = CrawlRequest.build().setProcessorContext(context).setUrl(new LinkNode(url))

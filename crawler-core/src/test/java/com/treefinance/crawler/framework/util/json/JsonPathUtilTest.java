...
public class JsonPathUtilTest extends BaseConfigTest {
    ...
    private class TestObj {
        ...
        public String toString() {
            return new ToStringBuilder(this, ToStringStyle.JSON_STYLE).append("tradeNumber", tradeNumber).append("amount", amount).append("tradeDetailUrl", tradeDetailUrl).append("otherSide", otherSide).append("tradeStatus", tradeStatus).append("tradeDatetime", tradeDatetime).append("title", title).append("tradeType", tradeType).toString();
        }
    }

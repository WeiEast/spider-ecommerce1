    ...
    public HttpResult<Object> init(CommonPluginParam param) {
        ...
        try {
            ...
            if (StringUtils.isBlank(pageContent)) {
                ...
                messageService.sendTaskLog(param.getTaskId(),"新浪邮箱h5登录-->初始化-->失败");
            ...
            messageService.sendTaskLog(param.getTaskId(),"新浪邮箱h5登录-->初始化-->成功");
    ...
    public HttpResult<Object> refeshPicCode(CommonPluginParam param) {
        ...
        try {
            ...
            if (response.getStatusCode() == 200) {
                messageService.sendTaskLog(param.getTaskId(),"新浪邮箱h5-->刷新图片验证码-->成功");
            ...
            messageService.sendTaskLog(param.getTaskId(),"新浪邮箱h5-->刷新图片验证码-->失败");
    ...
    public HttpResult<Object> submit(CommonPluginParam param) {
        ...
        try {
            ...
            if (pageContent.contains("101")) {
                ...
                messageService.sendTaskLog(param.getTaskId(),"新浪邮箱h5登陆-->校验-->失败");

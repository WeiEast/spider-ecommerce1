...
public class MailBillIllegalSubjectFilter extends RemovedFetchLinkNodeFilter {
    ...
    private static final Pattern subjectContainsPattern = Pattern
    ...
    private static final Pattern secondSubjectBlackListPattern = Pattern
            .compile(PropertiesConfiguration.getInstance().get("mail.subject.second.blacklist.pattern", "分期感恩季"));

    private static final Pattern subjectWhiteListPattern = Pattern

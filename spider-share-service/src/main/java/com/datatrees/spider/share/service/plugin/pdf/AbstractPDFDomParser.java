...
public abstract class AbstractPDFDomParser extends PDFTextStripper {
    ...
    private void processFontResources(PDResources resources, FontTable table) throws IOException {
        ...
        for (COSName name : resources.getXObjectNames()) {
            ...
            if (xobject instanceof PDFormXObject) {
                ...
                if (formResources != null) processFontResources(formResources, table);
            }
        }
    ...
    protected void processOperator(Operator operator, List<COSBase> arguments) throws IOException {
        ...
        // invoke named object - images
            ...
            if (!disableImages) processImageOperation(arguments);
        }
    ...
    protected void processTextPosition(TextPosition text) {
        if (text.isDiacritic()) {
            ...
            if (lastDia != null) {
                if (text.contains(lastDia)) text.mergeDiacritic(lastDia);
                lastDia = null;
            }
    ...
    private String findKnownFontFamily(String font) {
        for (String fontFamilyOn : cssFontFamily) {
            if (font.toLowerCase().lastIndexOf(fontFamilyOn.toLowerCase()) >= 0) return fontFamilyOn;
        }
        return "";
    }
    ...
    protected String getTitle() {
        ...
        if (title == null || title.isEmpty()) title = "PDF Document";

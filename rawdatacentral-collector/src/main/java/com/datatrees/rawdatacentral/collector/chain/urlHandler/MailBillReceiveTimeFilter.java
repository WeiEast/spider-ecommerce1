...
public class MailBillReceiveTimeFilter implements Filter {
    ...
    private static long maxMailReceiveInterval = PropertiesConfiguration.getInstance().getLong("max.mail.receive.interval",
            new Double(1000L * 3600L * 24L * 365L * 1.5).longValue());

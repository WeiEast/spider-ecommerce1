...
public class ActorTest extends BaseTest {
    ...
    public void testQQ1() throws InterruptedException {
        ...
        message.setEndURL("https://w.mail.qq.com/cgi-bin/today?sid=wIfp4pT5aR9YA0ceXcLT5vNw,4,qbTJSS0hBeXVTSy1LNzhuSDJDUlBBbSpJTmVmMmR6Um5JcFZWZkEqUkVxWV8.&first=1&mcookie=disabled");
    ...
    public void sc189() throws InterruptedException {
        ...
        properties.put("desuserInfo", "695F8CB9B03821E5197683F0044E991127AF3C478071A40198CA676430E4103E597D91C4C62FBDFBBDEE7F64E689BCE29C66D236FB2F55CAABBBAF547A645FC7F4D49AEC4DE51E9A91510AB01DC9C524F7F7CE09ACE04ED04A084BBC06BD791658EB8FAAF5F29EF6");
    ...
    public void Search139() throws InterruptedException {
        ...
        message.setEndURL("http://html5.mail.10086.cn/html/mailList.html?source=1&sid=MTQ3Mjg3NTg4MjAwMDUxNTQ1001A9923000005&rnd=804&comefrom=2066&useInnerWeb=0&k=1877&cguid=1211000222685&mtime=822");
        collector.processMessage(message);
        while (true) {
            Thread.sleep(5000);
        }
    ...
    public void spdTest() throws InterruptedException, IOException {
        ...
        message.setEndURL("https://ebill.spdbccc.com.cn/cloudbank-portal/loginController/toLoGwxxhgKshkz9X30Gi28FUoxFSvEIqexT6lbFpZVcNCA8xDh$PQzQNV9TX8FDfkU5ZrC0xcD6LOH0fup2EDRei0a8$V3baSLisjCZlA==");
        message.setWebsiteName("spdb.com.cn");
        message.getProperty().put("seedurl", "https://ebill.spdbccc.com.cn/cloudbank-portal/loginController/toLogin.action?zrz4ofa8h5IFb1udd/JAcjoWQd1OZbTumNYxL2UdZrb4uQ4thGA5DGWaIVJK2YX8Z1/5NNDAOkquZRzQb/NywFfXQAEMsqEUZUqxDbRxXvVt9KC30uyoWbGOBAOX7QuRPmiARNAWAfzg37VWDUz5iA==");
        collector.processMessage(message);
    }
